    ...
    return (
      <div>
        <div className={styles.EventInfo}>
          <img
            src="https://secure.meetupstatic.com/photos/event/8/c/e/0/600_466836064.jpeg"
            alt="test"
          />
          <div className={styles.Details}>
            ...
            <div>
              <button onClick={this.props.onIncrementMembers}>
                Add Member
              </button>
            </div>
          </div>
...
const mapStateToProps = (
  state: IEventInfoState,
  ownProps: IEventHubProps
): IStateProps => {
  return {
